...
function getEulerFromMat4(out, m) {
    ...
    var _a = tslib.__read(glMatrix.mat4.getScaling(glMatrix.vec3.create(), m), 3), sx = _a[0], sy = _a[1], sz = _a[2];
...
var Frustum = /** @class */ (function () {
    ...
    Frustum.prototype.extractFromVPMatrix = function (projectionMatrix) {
        // @ts-ignore
        var _a = tslib.__read(projectionMatrix, 16), m0 = _a[0], m1 = _a[1], m2 = _a[2], m3 = _a[3], m4 = _a[4], m5 = _a[5], m6 = _a[6], m7 = _a[7], m8 = _a[8], m9 = _a[9], m10 = _a[10], m11 = _a[11], m12 = _a[12], m13 = _a[13], m14 = _a[14], m15 = _a[15];
        // right
...
var Rectangle = /** @class */ (function () {
     ...
     */
    Rectangle.fromRect = function (rect) {
        return new Rectangle(rect.x, rect.y, rect.width, rect.height);
    };
    /**
     * will return a new rect instance
     */
    Rectangle.applyTransform = function (rect, matrix) {
        var topLeft = glMatrix.vec4.fromValues(rect.x, rect.y, 0, 1);
        var topRight = glMatrix.vec4.fromValues(rect.x + rect.width, rect.y, 0, 1);
        var bottomLeft = glMatrix.vec4.fromValues(rect.x, rect.y + rect.height, 0, 1);
        var bottomRight = glMatrix.vec4.fromValues(rect.x + rect.width, rect.y + rect.height, 0, 1);
        ...
        glMatrix.vec4.transformMat4(transformedTopLeft, topLeft, matrix);
        glMatrix.vec4.transformMat4(transformedTopRight, topRight, matrix);
        glMatrix.vec4.transformMat4(transformedBottomLeft, bottomLeft, matrix);
        glMatrix.vec4.transformMat4(transformedBottomRight, bottomRight, matrix);
 ...
 */
exports.CameraTrackingMode = void 0;
...
exports.CameraProjectionMode = void 0;
...
var Camera = /** @class */ (function () {
    ...
    Camera.prototype.setZoomByViewportPoint = function (zoom, viewportPoint) {
        ...
        var _c = tslib.__read(this.getPosition(), 2), px = _c[0], py = _c[1];
        var _d = tslib.__read(this.getFocalPoint(), 2), fx = _d[0], fy = _d[1];
    ...
    Camera.prototype.setPerspective = function (near, far, fov, aspect) {
        ...
        makePerspective(this.projectionMatrix, left, left + width, top - height, top, near, this.far, this.clipSpaceNearZ === exports.ClipSpaceNearZ.ZERO);
    ...
    Camera.prototype.setOrthographic = function (l, r, t, b, near, far) {
        ...
        if (this.clipSpaceNearZ === exports.ClipSpaceNearZ.NEGATIVE_ONE) {
    ...
    Camera.prototype.setAzimuth = function (az) {
        ...
        this.computeMatrix();
        this._getAxes();
        if (this.type === exports.CameraType.ORBITING ||
            this.type === exports.CameraType.EXPLORING) {
            this._getPosition();
        }
    ...
    Camera.prototype.computeMatrix = function () {
        ...
        var rotX = glMatrix.quat.setAxisAngle(glMatrix.quat.create(), [1, 0, 0], deg2rad(((this.rotateWorld && this.type !== exports.CameraType.TRACKING) ||
            this.type === exports.CameraType.TRACKING
            ? 1
            : -1) * this.elevation));
        var rotY = glMatrix.quat.setAxisAngle(glMatrix.quat.create(), [0, 1, 0], deg2rad(((this.rotateWorld && this.type !== exports.CameraType.TRACKING) ||
            this.type === exports.CameraType.TRACKING
            ? 1
            : -1) * this.azimuth));
...
var CSSStyleValue = /** @class */ (function () {
    ...
    CSSStyleValue.isAngle = function (unit) {
        return (unit === exports.UnitType.kDegrees ||
            unit === exports.UnitType.kRadians ||
            unit === exports.UnitType.kGradians ||
            unit === exports.UnitType.kTurns);
    };
    ...
    CSSStyleValue.isRelativeUnit = function (type) {
        return (type === exports.UnitType.kPercentage ||
            type === exports.UnitType.kEms ||
            // type === UnitType.kExs ||
...
var CSSColorValue = /** @class */ (function (_super) {
    tslib.__extends(CSSColorValue, _super);
...
var CSSGradientValue = /** @class */ (function (_super) {
    tslib.__extends(CSSGradientValue, _super);
...
var CSSKeywordValue = /** @class */ (function (_super) {
    tslib.__extends(CSSKeywordValue, _super);
...
var definedProps = function (obj) {
    return Object.fromEntries(Object.entries(obj).filter(function (_a) {
        var _b = tslib.__read(_a, 2), v = _b[1];
        return v !== undefined;
    }));
};
var FORMAT_ATTR_MAP = {
...
var CSSUnitValue = /** @class */ (function (_super) {
    tslib.__extends(CSSUnitValue, _super);
    function CSSUnitValue(value, unitOrName) {
        if (unitOrName === void 0) { unitOrName = exports.UnitType.kNumber; }
        var _this = _super.call(this) || this;
        var unit;
    ...
    CSSUnitValue.prototype.convertTo = function (target_unit) {
        ...
        if (canonical_unit !== toCanonicalUnit(target_unit) ||
            canonical_unit === exports.UnitType.kUnknown) {
            return null;
        }
...
})(exports.SortReason || (exports.SortReason = {}));
    ...
    if (colorStr[1] === '(' || colorStr[2] === '(') {
        if (type === 'l') {
            ...
            if (arr) {
                ...
                return [
                    new CSSGradientValue(exports.GradientType.LinearGradient, {
                        angle: getOrCreateUnitValue(parseFloat(arr[1]), 'deg'),
                        steps: steps.map(function (_a) {
                            var _b = tslib.__read(_a, 2), offset = _b[0], color = _b[1];
                            return ({
            ...
            if (parsedRadialGradient) {
                if (util.isString(parsedRadialGradient)) {
                    ...
                    return [
                        new CSSGradientValue(exports.GradientType.RadialGradient, parsedRadialGradient),
                    ];
                }
            }
        }
...
var parseColor = memoize(function (colorStr) {
    if (isPattern(colorStr)) {
        return tslib.__assign({ repetition: 'repeat' }, colorStr);
    }
    ...
    // constants
    var color = d3__namespace.color(colorStr);
    var rgba = [0, 0, 0, 0];
    if (color !== null) {
        rgba[0] = color.r || 0;
        rgba[1] = color.g || 0;
    ...
    return getOrCreateRGBA.apply(void 0, tslib.__spreadArray([], tslib.__read(rgba), false));
});
...
function convertPercentUnit(valueWithUnit, vec3Index, target, useMin) {
    ...
    if (valueWithUnit.unit === exports.UnitType.kPixels) {
        ...
        var bounds = target.nodeName === exports.Shape.GROUP
...
function clampedMergeNumbers(min, max) {
    return function (left, right) { return [
        left,
        right,
        function (x) { return numberToString(util.clamp(x, min, max)); },
    ]; };
}
...
function getPathBBox(segments, lineWidth) {
    ...
    for (var i = 0; i < segments.length; i++) {
        ...
        switch (segment.command) {
            case 'Q':
                box = gMath.quadBox(prePoint[0], prePoint[1], params[1], params[2], params[3], params[4]);
                break;
            case 'C':
                box = gMath.cubicBox(prePoint[0], prePoint[1], params[1], params[2], params[3], params[4], params[5], params[6]);
                break;
            case 'A':
                var arcParams = segment.arcParams;
                box = gMath.arcBox(arcParams.cx, arcParams.cy, arcParams.rx, arcParams.ry, arcParams.xRotation, arcParams.startAngle, arcParams.endAngle);
                break;
            default:
...
function getExtraFromSegmentWithAngle(segment, lineWidth) {
    ...
    if (!currentAngle ||
        ...
        util.isNumberEqual(currentAngle, 0)) {
        return {
            xExtra: 0,
            yExtra: 0,
        };
...
function commandsToPathString(commands, object, transform) {
    return commands.reduce(function (prev, cur) {
        ...
        if (cur[0] === 'M' || cur[0] === 'L') {
            ...
            var c = glMatrix.vec3.fromValues(cur[6], cur[7], 0);
            if (transform) {
...
function rectToCommands(width, height, x, y, radius) {
    ...
    if (radius) {
        var _a = tslib.__read(radius, 4), tlr = _a[0], trr = _a[1], brr = _a[2], blr = _a[3];
        ...
        case exports.Shape.RECT:
            ...
            commands = rectToCommands(width_1, height_1, x, y, hasRadius &&
                radius.map(function (r) {
                    return util.clamp(r, 0, Math.min(Math.abs(width_1) / 2, Math.abs(height_1) / 2));
                }));
            break;
        case exports.Shape.PATH:
            var absolutePath = object.parsedStyle.d.absolutePath;
            commands = tslib.__spreadArray([], tslib.__read(absolutePath), false);
            break;
    }
    if (commands.length) {
...
function parsePath(path) {
    return (util.isString(path) ? memoizedParsePath(path) : internalParsePath(path));
}
function mergePaths(left, right, object) {
    ...
    var curve0 = util.getDrawDirection(curves[0]) !== util.getDrawDirection(curves[1])
        ? util.reverseCurve(curves[0])
        : util.clonePath(curves[0]);
    return [
        curve0,
        util.getRotatedCurve(curves[1], curve0),
        function (pathArray) {
...
function parsePoints(pointsOrStr, object) {
    ...
    if (util.isString(pointsOrStr)) {
        points = pointsOrStr.split(' ').map(function (pointStr) {
            var _a = tslib.__read(pointStr.split(','), 2), x = _a[0], y = _a[1];
...
var BUILT_IN_PROPERTIES = [
    ...
    },
    {
        ...
        d: function (nodeName) {
            if (nodeName === exports.Shape.PATH ||
                nodeName === exports.Shape.POLYGON ||
                nodeName === exports.Shape.POLYLINE) {
                return '4';
            }
            return '10';
        },
...
var DefaultStyleValueRegistry = /** @class */ (function () {
    ...
    DefaultStyleValueRegistry.prototype.registerMetadata = function (metadata) {
        tslib.__spreadArray([metadata.n], tslib.__read((metadata.a || [])), false).forEach(function (name) {
    ...
    DefaultStyleValueRegistry.prototype.processProperties = function (object, attributes, options) {
        ...
        if (!this.runtime.enableCSSParsing) {
            ...
            // @ts-ignore
            if (attributes.d === '') {
                object.parsedStyle.d = tslib.__assign({}, EMPTY_PARSED_PATH);
            }
            // @ts-ignore
            if (attributes.d) {
            ...
            if (!util.isUndefined(attributes.clipPath)) {
    ...
    DefaultStyleValueRegistry.prototype.updateGeometry = function (object) {
        ...
        if (geometryUpdater) {
            ...
            var expansion = nodeName === exports.Shape.POLYLINE ||
                nodeName === exports.Shape.POLYGON ||
                nodeName === exports.Shape.PATH
                ? Math.SQRT2
                : 0.5;
    ...
    DefaultStyleValueRegistry.prototype.updateSizeAttenuation = function (node, zoom) {
        if (node.style.isSizeAttenuation) {
            ...
            if (node.nodeName === exports.Shape.CIRCLE) {
                if (!node.style.rawR) {
...
var CSSPropertyOffsetDistance = /** @class */ (function () {
    ...
    CSSPropertyOffsetDistance.prototype.postProcessor = function (object) {
        ...
        if (nodeName === exports.Shape.LINE ||
            nodeName === exports.Shape.PATH ||
            nodeName === exports.Shape.POLYLINE) {
...
var CSSPropertyShadowBlur = /** @class */ (function (_super) {
    tslib.__extends(CSSPropertyShadowBlur, _super);
...
var AsyncParallelHook = /** @class */ (function () {
    ...
    AsyncParallelHook.prototype.promise = function () {
        ...
        return Promise.all(this.callbacks.map(function (callback) {
            return callback.apply(void 0, tslib.__spreadArray([], tslib.__read(args), false));
        }));
    };
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (_a = this.callbacks)[0].apply(_a, tslib.__spreadArray([], tslib.__read(args), false))];
                    case 1:
                        result = _b.sent();
                        i = 0;
                        _b.label = 2;
...
var tmpMat1 = glMatrix.mat4.create();
var tmpMat2 = glMatrix.mat4.create();
function parsedTransformToMat4(transform, object) {
    if (transform.length) {
        var m_1 = glMatrix.mat4.identity(tmpMat1);
        transform.forEach(function (parsed) {
            ...
            if (t === 'scale') {
                ...
                glMatrix.mat4.fromScaling(tmpMat2, [newScale[0], newScale[1], 1]);
            }
            else if (t === 'scalex') {
                var newScale = (d === null || d === void 0 ? void 0 : d.map(function (s) { return Math.max(s.value, SCALE_EPSILON); })) || [1];
                glMatrix.mat4.fromScaling(tmpMat2, [newScale[0], 1, 1]);
            }
            else if (t === 'scaley') {
                var newScale = (d === null || d === void 0 ? void 0 : d.map(function (s) { return Math.max(s.value, SCALE_EPSILON); })) || [1];
                glMatrix.mat4.fromScaling(tmpMat2, [1, newScale[0], 1]);
            }
            else if (t === 'scalez') {
                var newScale = (d === null || d === void 0 ? void 0 : d.map(function (s) { return Math.max(s.value, SCALE_EPSILON); })) || [1];
                glMatrix.mat4.fromScaling(tmpMat2, [1, 1, newScale[0]]);
            }
            else if (t === 'scale3d') {
                var newScale = (d === null || d === void 0 ? void 0 : d.map(function (s) { return Math.max(s.value, SCALE_EPSILON); })) || [
                    1, 1, 1,
                ];
                glMatrix.mat4.fromScaling(tmpMat2, [newScale[0], newScale[1], newScale[2]]);
            }
            else if (t === 'translate') {
                var newTranslation = d || [Opx, Opx];
                glMatrix.mat4.fromTranslation(tmpMat2, [
                ...
                glMatrix.mat4.fromTranslation(tmpMat2, [newTranslation[0].value, 0, 0]);
            }
            else if (t === 'translatey') {
                var newTranslation = d || [Opx];
                glMatrix.mat4.fromTranslation(tmpMat2, [0, newTranslation[0].value, 0]);
            }
            else if (t === 'translatez') {
                var newTranslation = d || [Opx];
                glMatrix.mat4.fromTranslation(tmpMat2, [0, 0, newTranslation[0].value]);
            }
                ...
                glMatrix.mat4.fromZRotation(tmpMat2, deg2rad(convertAngleUnit(newAngles[0])));
            }
            else if (t === 'rotatex') {
                var newAngles = d || [Odeg];
                glMatrix.mat4.fromXRotation(tmpMat2, deg2rad(convertAngleUnit(newAngles[0])));
            }
            else if (t === 'rotatey') {
                var newAngles = d || [Odeg];
                glMatrix.mat4.fromYRotation(tmpMat2, deg2rad(convertAngleUnit(newAngles[0])));
            }
            else if (t === 'rotatez') {
                var newAngles = d || [Odeg];
                glMatrix.mat4.fromZRotation(tmpMat2, deg2rad(convertAngleUnit(newAngles[0])));
                ...
                glMatrix.mat4.fromRotation(tmpMat2, deg2rad(convertAngleUnit(newAngles[3])), [
                    newAngles[0].value,
                    newAngles[1].value,
                    newAngles[2].value,
                ]);
                ...
                glMatrix.mat4.set(tmpMat2, a, b, 0, 0, c, dd, 0, 0, 0, 0, 1, 0, tx, ty, 0, 1);
            }
            else if (t === 'matrix3d') {
                // @ts-ignore
                glMatrix.mat4.set.apply(glMatrix.mat4, tslib.__spreadArray([tmpMat2], tslib.__read(d.map(function (s) { return s.value; })), false));
            }
            glMatrix.mat4.mul(m_1, m_1, tmpMat2);
        });
...
var CSSPropertyTransformOrigin = /** @class */ (function () {
    ...
    CSSPropertyTransformOrigin.prototype.postProcessor = function (object) {
        ...
        if (transformOrigin[0].unit === exports.UnitType.kPixels &&
            transformOrigin[1].unit === exports.UnitType.kPixels) {
    ...
    CSSPropertyZIndex.prototype.postProcessor = function (object) {
        if (object.parentNode) {
            ...
            if (parentSortable) {
                ...
                parentSortable.dirtyReason = exports.SortReason.Z_INDEX_CHANGED;
            }
        }
    };
...
var PolylineUpdater = /** @class */ (function () {
    ...
    PolylineUpdater.prototype.update = function (parsedStyle) {
        if (parsedStyle.points && util.isArray(parsedStyle.points.points)) {
            ...
            var minX = Math.min.apply(Math, tslib.__spreadArray([], tslib.__read(points.map(function (point) { return point[0]; })), false));
            var maxX = Math.max.apply(Math, tslib.__spreadArray([], tslib.__read(points.map(function (point) { return point[0]; })), false));
            var minY = Math.min.apply(Math, tslib.__spreadArray([], tslib.__read(points.map(function (point) { return point[1]; })), false));
            var maxY = Math.max.apply(Math, tslib.__spreadArray([], tslib.__read(points.map(function (point) { return point[1]; })), false));
            var width = maxX - minX;
            var height = maxY - minY;
            var hwidth = width / 2;
            var hheight = height / 2;
...
var FederatedMouseEvent = /** @class */ (function (_super) {
    tslib.__extends(FederatedMouseEvent, _super);
...
var FederatedPointerEvent = /** @class */ (function (_super) {
    tslib.__extends(FederatedPointerEvent, _super);
...
var FederatedWheelEvent = /** @class */ (function (_super) {
    tslib.__extends(FederatedWheelEvent, _super);
...
var CustomEvent = /** @class */ (function (_super) {
    tslib.__extends(CustomEvent, _super);
...
var EventTarget = /** @class */ (function () {
    ...
    EventTarget.prototype.addEventListener = function (type, listener, options) {
        ...
        if (type.indexOf(DELEGATION_SPLITTER) > -1) {
            var _a = tslib.__read(type.split(DELEGATION_SPLITTER), 2), name_1 = _a[0], eventType = _a[1];
            type = eventType;
        ...
        if (useDelegatedName) {
            ...
            listener = function () {
                ...
                // @ts-ignore
                originListener_1.apply(void 0, tslib.__spreadArray([], tslib.__read(args), false));
            };
        }
        if (once) {
...
var Node = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Node.prototype, "textContent", {
        ...
        get: function () {
            ...
            try {
                for (var _b = tslib.__values(this.childNodes), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var child = _c.value;
...
var EventService = /** @class */ (function () {
    ...
    EventService.prototype.getExistedHTML = function (event) {
        ...
        if (event.nativeEvent.composedPath) {
            try {
                for (var _b = tslib.__values(event.nativeEvent.composedPath()), _c = _b.next(); !_c.done; _c = _b.next()) {
...
var OffscreenCanvasCreator = /** @class */ (function () {
    ...
    OffscreenCanvasCreator.prototype.getOrCreateCanvas = function (offscreenCanvas, contextAttributes) {
        ...
        if (offscreenCanvas || runtime.offscreenCanvas) {
            ...
            this.context = this.canvas.getContext('2d', tslib.__assign({ willReadFrequently: true }, contextAttributes));
        }
        else {
            try {
...
var RenderingService = /** @class */ (function () {
    ...
    RenderingService.prototype.init = function (callback) {
        var _this = this;
        var context = tslib.__assign(tslib.__assign({}, this.globalRuntime), this.context);
    ...
    RenderingService.prototype.disableDirtyRectangleRendering = function () {
        ...
        return (!enableDirtyRectangleRendering ||
            this.context.renderingContext.renderReasons.has(exports.RenderReason.CAMERA_CHANGED));
    };
    RenderingService.prototype.render = function (canvasConfig, frame, rerenderCallback) {
        ...
        if (renderingContext.renderReasons.size && this.inited) {
            ...
            var onlyCameraChanged = renderingContext.renderReasons.size === 1 &&
                renderingContext.renderReasons.has(exports.RenderReason.CAMERA_CHANGED);
    ...
    RenderingService.prototype.sort = function (displayObject, sortable) {
        if (sortable.sorted &&
            sortable.dirtyReason !== exports.SortReason.Z_INDEX_CHANGED) {
...
var MutationEvent = /** @class */ (function (_super) {
    tslib.__extends(MutationEvent, _super);
...
var DefaultSceneGraphService = /** @class */ (function () {
    ...
    DefaultSceneGraphService.prototype.attach = function (child, parent, index) {
        ...
        if (((_a = sortable === null || sortable === void 0 ? void 0 : sortable.sorted) === null || _a === void 0 ? void 0 : _a.length) ||
            ...
            sortable.dirty = true;
            sortable.dirtyReason = exports.SortReason.ADDED;
        }
    ...
    DefaultSceneGraphService.prototype.detach = function (child) {
        ...
        if (child.parentNode) {
            ...
            if (((_a = sortable === null || sortable === void 0 ? void 0 : sortable.sorted) === null || _a === void 0 ? void 0 : _a.length) ||
                ...
                sortable.dirty = true;
                sortable.dirtyReason = exports.SortReason.REMOVED;
            }
    ...
    DefaultSceneGraphService.prototype.triggerPendingEvents = function () {
        ...
        this.pendingEvents.forEach(function (_a) {
            var _b = tslib.__read(_a, 2), element = _b[0], detail = _b[1];
        ...
        if (dependencyMap) {
            Object.keys(dependencyMap).forEach(function (name) {
                dependencyMap[name].forEach(function (target) {
                    ...
                    target.dispatchEvent(new MutationEvent(exports.ElementEvent.ATTR_MODIFIED, target, _this, _this, name, MutationEvent.MODIFICATION, _this, _this));
    ...
    DefaultSceneGraphService.prototype.getBoundingClientRect = function (element) {
        ...
        if (aabb) {
            var _c = tslib.__read(aabb.getMin(), 2), left = _c[0], top_1 = _c[1];
            var _d = tslib.__read(aabb.getMax(), 2), right = _d[0], bottom = _d[1];
...
var TextService = /** @class */ (function () {
    function TextService(runtime) {
        ...
        this.trimByKinsokuShorui = function (prev) {
            var next = tslib.__spreadArray([], tslib.__read(prev), false);
...
var geometryUpdaterFactory = (function () {
    ...
    return _a = {},
        _a[exports.Shape.CIRCLE] = new CircleUpdater(),
        _a[exports.Shape.ELLIPSE] = new EllipseUpdater(),
        _a[exports.Shape.RECT] = rectUpdater,
        _a[exports.Shape.IMAGE] = rectUpdater,
        _a[exports.Shape.GROUP] = new GroupUpdater(),
        _a[exports.Shape.LINE] = new LineUpdater(),
        _a[exports.Shape.TEXT] = new TextUpdater(runtime),
        _a[exports.Shape.POLYLINE] = polylineUpdater,
        _a[exports.Shape.POLYGON] = polylineUpdater,
        _a[exports.Shape.PATH] = new PathUpdater(),
        _a[exports.Shape.HTML] = null,
        _a[exports.Shape.MESH] = null,
        _a;
})();
var CSSPropertySyntaxFactory = (function () {
    ...
    return _a = {},
        _a[exports.PropertySyntax.PERCENTAGE] = null,
        _a[exports.PropertySyntax.NUMBER] = new CSSPropertyNumber(),
        _a[exports.PropertySyntax.ANGLE] = new CSSPropertyAngle(),
        _a[exports.PropertySyntax.DEFINED_PATH] = new CSSPropertyClipPath(),
        _a[exports.PropertySyntax.PAINT] = color,
        _a[exports.PropertySyntax.COLOR] = color,
        _a[exports.PropertySyntax.FILTER] = new CSSPropertyFilter(),
        _a[exports.PropertySyntax.LENGTH] = length,
        _a[exports.PropertySyntax.LENGTH_PERCENTAGE] = length,
        _a[exports.PropertySyntax.LENGTH_PERCENTAGE_12] = new CSSPropertyLengthOrPercentage12(),
        _a[exports.PropertySyntax.LENGTH_PERCENTAGE_14] = new CSSPropertyLengthOrPercentage14(),
        _a[exports.PropertySyntax.COORDINATE] = new CSSPropertyLengthOrPercentage(),
        _a[exports.PropertySyntax.OFFSET_DISTANCE] = new CSSPropertyOffsetDistance(),
        _a[exports.PropertySyntax.OPACITY_VALUE] = new CSSPropertyOpacity(),
        _a[exports.PropertySyntax.PATH] = new CSSPropertyPath(),
        _a[exports.PropertySyntax.LIST_OF_POINTS] = new CSSPropertyPoints(),
        _a[exports.PropertySyntax.SHADOW_BLUR] = new CSSPropertyShadowBlur(),
        _a[exports.PropertySyntax.TEXT] = new CSSPropertyText(),
        _a[exports.PropertySyntax.TEXT_TRANSFORM] = new CSSPropertyTextTransform(),
        _a[exports.PropertySyntax.TRANSFORM] = new CSSPropertyTransform(),
        _a[exports.PropertySyntax.TRANSFORM_ORIGIN] = new CSSPropertyTransformOrigin(),
        _a[exports.PropertySyntax.Z_INDEX] = new CSSPropertyZIndex(),
        _a[exports.PropertySyntax.MARKER] = new CSSPropertyMarker(),
        _a;
})();
...
var Element = /** @class */ (function (_super) {
    ...
    Element.prototype.before = function () {
        ...
        if (this.parentNode) {
            var index = this.parentNode.childNodes.indexOf(this);
            var _b = tslib.__read(nodes), first = _b[0], rest = _b.slice(1);
            this.parentNode.appendChild(first, index);
            (_a = first).after.apply(_a, tslib.__spreadArray([], tslib.__read(rest), false));
        }
    };
    /**
    ...
    Element.prototype.replaceWith = function () {
        ...
        this.after.apply(this, tslib.__spreadArray([], tslib.__read(nodes), false));
        this.remove();
    };
    /**
    ...
    Element.prototype.replaceChildren = function () {
        ...
        this.append.apply(this, tslib.__spreadArray([], tslib.__read(nodes), false));
    };
    /**
...
var INHERITABLE_STYLE_PROPS = tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(INHERITABLE_BASE_STYLE_PROPS), false), [
    'fontSize',
    'fontFamily',
    'fontStyle',
    'fontWeight',
...
var DisplayObject = /** @class */ (function (_super) {
    tslib.__extends(DisplayObject, _super);
    ...
    DisplayObject.prototype.cloneNode = function (deep, customCloneFunc) {
        var clonedStyle = tslib.__assign({}, this.attributes);
    ...
    DisplayObject.prototype.getBBox = function () {
        ...
        var _a = tslib.__read(aabb.getMin(), 2), left = _a[0], top = _a[1];
        var _b = tslib.__read(aabb.getMax(), 2), right = _b[0], bottom = _b[1];
    ...
    DisplayObject.prototype.getEulerAngles = function () {
        var _a = tslib.__read(getEuler(glMatrix.vec3.create(), runtime.sceneGraphService.getWorldTransform(this)), 3), ez = _a[2];
        return rad2deg(ez);
    };
    /**
    ...
    DisplayObject.prototype.getLocalEulerAngles = function () {
        var _a = tslib.__read(getEuler(glMatrix.vec3.create(), runtime.sceneGraphService.getLocalRotation(this)), 3), ez = _a[2];
        return rad2deg(ez);
    };
    /**
     * set euler angles(degrees) in world space
    ...
    DisplayObject.prototype.toFront = function () {
        if (this.parentNode) {
            this.style.zIndex =
                Math.max.apply(Math, tslib.__spreadArray([], tslib.__read(this.parentNode.children.map(function (child) {
    ...
    DisplayObject.prototype.toBack = function () {
        if (this.parentNode) {
            this.style.zIndex =
                Math.min.apply(Math, tslib.__spreadArray([], tslib.__read(this.parentNode.children.map(function (child) {
                    return Number(child.style.zIndex);
                })), false)) - 1;
        }
        return this;
    ...
    DisplayObject.prototype.attr = function () {
        ...
        var _a = tslib.__read(args, 2), name = _a[0], value = _a[1];
        if (!name) {
    ...
    DisplayObject.prototype.getMatrix = function (transformMat4) {
        ...
        var _a = tslib.__read(glMatrix.mat4.getTranslation(glMatrix.vec3.create(), transform), 2), tx = _a[0], ty = _a[1];
        var _b = tslib.__read(glMatrix.mat4.getScaling(glMatrix.vec3.create(), transform), 2), sx = _b[0], sy = _b[1];
        var rotation = glMatrix.mat4.getRotation(glMatrix.quat.create(), transform);
        var _c = tslib.__read(getEuler(glMatrix.vec3.create(), rotation), 3), eux = _c[0], euz = _c[2];
    ...
    DisplayObject.prototype.setMatrix = function (mat) {
        var _a = tslib.__read(decompose(mat), 5), tx = _a[0], ty = _a[1], scalingX = _a[2], scalingY = _a[3], angle = _a[4];
...
var Circle = /** @class */ (function (_super) {
    ...
    function Circle(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, tslib.__assign({ type: exports.Shape.CIRCLE }, options)) || this;
    }
    return Circle;
}(DisplayObject));
...
var CustomElement = /** @class */ (function (_super) {
    tslib.__extends(CustomElement, _super);
    // private shadowNodes: DisplayObject[] = [];
    function CustomElement(_a) {
        if (_a === void 0) { _a = {}; }
        var _this = this;
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        _this = _super.call(this, tslib.__assign({ style: runtime.enableCSSParsing
                ? tslib.__assign({}, style) : tslib.__assign({}, style) }, rest)) || this;
...
var Ellipse = /** @class */ (function (_super) {
    ...
    function Ellipse(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, tslib.__assign({ type: exports.Shape.ELLIPSE }, options)) || this;
    }
    return Ellipse;
}(DisplayObject));
...
var Group = /** @class */ (function (_super) {
    ...
    function Group(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, tslib.__assign({ type: exports.Shape.GROUP }, options)) || this;
    }
    return Group;
}(DisplayObject));
...
var HTML = /** @class */ (function (_super) {
    tslib.__extends(HTML, _super);
    function HTML(_a) {
        if (_a === void 0) { _a = {}; }
        var _this = this;
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        _this = _super.call(this, tslib.__assign({ type: exports.Shape.HTML, style: runtime.enableCSSParsing
                ? tslib.__assign({ x: '', y: '', width: 'auto', height: 'auto', innerHTML: '' }, style) : tslib.__assign({}, style) }, rest)) || this;
    ...
    HTML.prototype.getBoundingClientRect = function () {
        if (this.parsedStyle.$el) {
            var cameraMatrix = this.ownerDocument.defaultView
                .getCamera()
                .getOrthoMatrix();
            var bBox = this.parsedStyle.$el.getBoundingClientRect();
            return Rectangle.applyTransform(bBox, glMatrix.mat4.invert(glMatrix.mat4.create(), cameraMatrix));
        }
        else {
...
var Image = /** @class */ (function (_super) {
    tslib.__extends(Image, _super);
    function Image(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, tslib.__assign({ type: exports.Shape.IMAGE }, options)) || this;
    }
    return Image;
}(DisplayObject));
...
var Line = /** @class */ (function (_super) {
    ...
    function Line(_a) {
        ...
        var _this = this;
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        _this = _super.call(this, tslib.__assign({ type: exports.Shape.LINE, style: tslib.__assign({ x1: 0, y1: 0, x2: 0, y2: 0, z1: 0, z2: 0 }, style) }, rest)) || this;
    ...
    Line.prototype.getPoint = function (ratio, inWorldSpace) {
        ...
        var _b = gMath.linePointAt(x1, y1, x2, y2, ratio), x = _b.x, y = _b.y;
        var transformed = glMatrix.vec3.transformMat4(glMatrix.vec3.create(), glMatrix.vec3.fromValues(x, y, 0), inWorldSpace ? this.getWorldTransform() : this.getLocalTransform());
    ...
    Line.prototype.getTotalLength = function () {
        // TODO: account for z1/z2 in 3D line
        var _a = this.parsedStyle, x1 = _a.x1, y1 = _a.y1, x2 = _a.x2, y2 = _a.y2;
        return gMath.lineLength(x1, y1, x2, y2);
    };
    return Line;
}(DisplayObject));

var Path = /** @class */ (function (_super) {
    tslib.__extends(Path, _super);
    function Path(_a) {
        if (_a === void 0) { _a = {}; }
        var _this = this;
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        _this = _super.call(this, tslib.__assign({ type: exports.Shape.PATH, style: runtime.enableCSSParsing
                ? tslib.__assign({ d: '', miterLimit: '' }, style) : tslib.__assign({}, style), initialParsedStyle: runtime.enableCSSParsing
                ? null
                : {
                    miterLimit: 4,
                    d: tslib.__assign({}, EMPTY_PARSED_PATH),
                } }, rest)) || this;
        _this.markerStartAngle = 0;
        _this.markerEndAngle = 0;
        /**
    ...
    Path.prototype.transformMarker = function (isStart) {
        ...
        var originalAngle;
        if (isStart) {
            var _b = tslib.__read(this.getStartTangent(), 2), p1 = _b[0], p2 = _b[1];
            ox = p2[0];
            oy = p2[1];
            x = p1[0] - p2[0];
            y = p1[1] - p2[1];
            ...
            var _c = tslib.__read(this.getEndTangent(), 2), p1 = _c[0], p2 = _c[1];
            ox = p2[0];
            oy = p2[1];
            x = p1[0] - p2[0];
            y = p1[1] - p2[1];
    ...
    Path.prototype.placeMarkerMid = function (marker) {
        ...
        if (marker && isDisplayObject(marker)) {
            for (var i = 1; i < segments.length - 1; i++) {
                var _a = tslib.__read(segments[i].currentPoint, 2), ox = _a[0], oy = _a[1];
    ...
    Path.prototype.getPointAtLength = function (distance, inWorldSpace) {
        ...
        var _a = util.getPointAtLength(absolutePath, distance), x = _a.x, y = _a.y;
        var transformed = glMatrix.vec3.transformMat4(glMatrix.vec3.create(), glMatrix.vec3.fromValues(x, y, 0), inWorldSpace ? this.getWorldTransform() : this.getLocalTransform());
        // apply local transformation
        return new Point(transformed[0], transformed[1]);
    };
...
var Polygon = /** @class */ (function (_super) {
    ...
    function Polygon(_a) {
        ...
        var _this = this;
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        _this = _super.call(this, tslib.__assign({ type: exports.Shape.POLYGON, style: runtime.enableCSSParsing
                ? tslib.__assign({ points: '', miterLimit: '', isClosed: true }, style) : tslib.__assign({}, style), initialParsedStyle: runtime.enableCSSParsing
                ? null
                : {
                    points: {
                        points: [],
...
var Polyline = /** @class */ (function (_super) {
    ...
    function Polyline(_a) {
        if (_a === void 0) { _a = {}; }
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        return _super.call(this, tslib.__assign({ type: exports.Shape.POLYLINE, style: runtime.enableCSSParsing
                ? tslib.__assign({ points: '', miterLimit: '', isClosed: false }, style) : tslib.__assign({}, style), initialParsedStyle: runtime.enableCSSParsing
                ? null
                : {
                    points: {
                        points: [],
    ...
    Polyline.prototype.getPoint = function (ratio, inWorldSpace) {
        ...
        if (this.parsedStyle.points.segments.length === 0) {
            ...
            points.forEach(function (p, i) {
                if (points[i + 1]) {
                    ...
                    segmentL_1 = gMath.lineLength(p[0], p[1], points[i + 1][0], points[i + 1][1]);
        ...
        var _a = gMath.linePointAt(points[index][0], points[index][1], points[index + 1][0], points[index + 1][1], subt), x = _a.x, y = _a.y;
        var transformed = glMatrix.vec3.transformMat4(glMatrix.vec3.create(), glMatrix.vec3.fromValues(x, y, 0), inWorldSpace ? this.getWorldTransform() : this.getLocalTransform());
        // apply local transformation
        return new Point(transformed[0], transformed[1]);
    };
...
var Rect = /** @class */ (function (_super) {
    tslib.__extends(Rect, _super);
    function Rect(options) {
        if (options === void 0) { options = {}; }
        return _super.call(this, tslib.__assign({ type: exports.Shape.RECT }, options)) || this;
    }
    return Rect;
}(DisplayObject));
...
var Text = /** @class */ (function (_super) {
    ...
    function Text(_a) {
        if (_a === void 0) { _a = {}; }
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        return _super.call(this, tslib.__assign({ type: exports.Shape.TEXT, style: runtime.enableCSSParsing
                ? tslib.__assign({ x: '', y: '', text: '', fontSize: '', fontFamily: '', fontStyle: '', fontWeight: '', fontVariant: '', textAlign: '', textBaseline: '', textTransform: '', fill: 'black', letterSpacing: '', lineHeight: '', miterLimit: '', 
                    // whiteSpace: 'pre',
                    wordWrap: false, wordWrapWidth: 0, leading: 0, dx: '', dy: '' }, style) : tslib.__assign({ fill: 'black' }, style) }, rest)) || this;
    }
...
var EventPlugin = /** @class */ (function () {
    function EventPlugin() {
        ...
        this.onPointerMove = function (nativeEvent) {
            ...
            try {
                for (var normalizedEvents_1 = tslib.__values(normalizedEvents), normalizedEvents_1_1 = normalizedEvents_1.next(); !normalizedEvents_1_1.done; normalizedEvents_1_1 = normalizedEvents_1.next()) {
        ...
        this.onClick = function (nativeEvent) {
            ...
            var normalizedEvents = _this.normalizeToPointerEvent(nativeEvent, canvas);
            try {
                for (var normalizedEvents_2 = tslib.__values(normalizedEvents), normalizedEvents_2_1 = normalizedEvents_2.next(); !normalizedEvents_2_1.done; normalizedEvents_2_1 = normalizedEvents_2.next()) {
    ...
    EventPlugin.prototype.apply = function (context) {
        ...
        renderingService.hooks.pointerUp.tap(EventPlugin.tag, function (nativeEvent) {
            ...
            var normalizedEvents = _this.normalizeToPointerEvent(nativeEvent, canvas);
            try {
                for (var normalizedEvents_3 = tslib.__values(normalizedEvents), normalizedEvents_3_1 = normalizedEvents_3.next(); !normalizedEvents_3_1.done; normalizedEvents_3_1 = normalizedEvents_3.next()) {
        ...
        renderingService.hooks.pointerCancel.tap(EventPlugin.tag, function (nativeEvent) {
            ...
            var normalizedEvents = _this.normalizeToPointerEvent(nativeEvent, canvas);
            try {
                for (var normalizedEvents_4 = tslib.__values(normalizedEvents), normalizedEvents_4_1 = normalizedEvents_4.next(); !normalizedEvents_4_1.done; normalizedEvents_4_1 = normalizedEvents_4.next()) {
    ...
    EventPlugin.prototype.normalizeToPointerEvent = function (event, canvas) {
        ...
        if (canvas.isTouchEvent(event)) {
            for (var i = 0; i < event.changedTouches.length; i++) {
                ...
                if (util.isUndefined(touch.button))
                    touch.button = 0;
                if (util.isUndefined(touch.buttons))
                    touch.buttons = 1;
                if (util.isUndefined(touch.isPrimary)) {
                    touch.isPrimary =
                        event.touches.length === 1 && event.type === 'touchstart';
                }
                if (util.isUndefined(touch.width))
                    touch.width = touch.radiusX || 1;
                if (util.isUndefined(touch.height))
                    touch.height = touch.radiusY || 1;
                if (util.isUndefined(touch.tiltX))
                    touch.tiltX = 0;
                if (util.isUndefined(touch.tiltY))
                    touch.tiltY = 0;
                if (util.isUndefined(touch.pointerType))
                    touch.pointerType = 'touch';
                // @see https://developer.mozilla.org/zh-CN/docs/Web/API/Touch/identifier
                if (util.isUndefined(touch.pointerId))
                    touch.pointerId = touch.identifier || 0;
                if (util.isUndefined(touch.pressure))
                    touch.pressure = touch.force || 0.5;
                if (util.isUndefined(touch.twist))
                    touch.twist = 0;
                if (util.isUndefined(touch.tangentialPressure))
            ...
            var tempEvent = event;
            if (util.isUndefined(tempEvent.isPrimary))
                tempEvent.isPrimary = true;
            if (util.isUndefined(tempEvent.width))
                tempEvent.width = 1;
            if (util.isUndefined(tempEvent.height))
                tempEvent.height = 1;
            if (util.isUndefined(tempEvent.tiltX))
                tempEvent.tiltX = 0;
            if (util.isUndefined(tempEvent.tiltY))
                tempEvent.tiltY = 0;
            if (util.isUndefined(tempEvent.pointerType))
                tempEvent.pointerType = 'mouse';
            if (util.isUndefined(tempEvent.pointerId))
                tempEvent.pointerId = MOUSE_POINTER_ID;
            if (util.isUndefined(tempEvent.pressure))
                tempEvent.pressure = 0.5;
            if (util.isUndefined(tempEvent.twist))
                tempEvent.twist = 0;
            if (util.isUndefined(tempEvent.tangentialPressure))
...
var shape2D = [
    ...
    exports.Shape.ELLIPSE,
    exports.Shape.IMAGE,
    exports.Shape.RECT,
    exports.Shape.LINE,
    exports.Shape.POLYLINE,
    exports.Shape.POLYGON,
    exports.Shape.TEXT,
    exports.Shape.PATH,
    exports.Shape.HTML,
];
var FrustumCullingStrategy = /** @class */ (function () {
    ...
    FrustumCullingStrategy.prototype.computeVisibilityWithPlaneMask = function (object, aabb, parentPlaneMask, planes) {
        ...
        for (var k = 0, len = planes.length; k < len; ++k) {
            ...
            if (glMatrix.vec3.dot(normal, aabb.getPositiveFarPoint(planes[k])) + distance <
                0) {
                return exports.Mask.OUTSIDE;
            }
            if (glMatrix.vec3.dot(normal, aabb.getNegativeFarPoint(planes[k])) + distance <
                0) {
    ...
    PrepareRendererPlugin.prototype.syncRTree = function (force) {
        ...
        Array.from(this.toSync)
            ...
            if (renderBounds) {
                ...
                var _a = tslib.__read(renderBounds.getMin(), 2), minX = _a[0], minY = _a[1];
                var _b = tslib.__read(renderBounds.getMax(), 2), maxX = _b[0], maxY = _b[1];
                if (!rBushNode.aabb) {
                    rBushNode.aabb = {};
                }
...
var Canvas = /** @class */ (function (_super) {
    ...
    Canvas.prototype.initDefaultCamera = function (width, height, clipSpaceNearZ) {
        ...
        camera
            .setType(exports.CameraType.EXPLORING, exports.CameraTrackingMode.DEFAULT)
        ...
        camera.eventEmitter.on(CameraEvent.UPDATED, function () {
            _this.context.renderingContext.renderReasons.add(exports.RenderReason.CAMERA_CHANGED);
            if (runtime.enableSizeAttenuation &&
    ...
    Canvas.prototype.resize = function (width, height) {
        ...
        this.dispatchEvent(new CustomEvent(exports.CanvasEvent.RESIZE, { width: width, height: height }));
    };
    ...
    Canvas.prototype.initRenderer = function (renderer, firstContentfullPaint) {
        ...
        this.context.contextService = new this.context.ContextService(tslib.__assign(tslib.__assign({}, runtime), this.context));
    ...
    Canvas.prototype.initRenderingService = function (renderer, firstContentfullPaint, async) {
        ...
        this.context.renderingService.init(function () {
            ...
            if (firstContentfullPaint) {
                ...
                _this.dispatchEvent(new CustomEvent(exports.CanvasEvent.RENDERER_CHANGED));
            }
    ...
    Canvas.prototype.setRenderer = function (renderer) {
        ...
        tslib.__spreadArray([], tslib.__read(oldRenderer === null || oldRenderer === void 0 ? void 0 : oldRenderer.getPlugins()), false).reverse().forEach(function (plugin) {
...
exports.Group = Group;
exports.GroupUpdater = GroupUpdater;
exports.HTML = HTML;
exports.Image = Image;
exports.Line = Line;
