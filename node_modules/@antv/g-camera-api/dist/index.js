...
var AdvancedCamera = /** @class */ (function (_super) {
    ...
    AdvancedCamera.prototype.gotoLandmark = function (name, options) {
        ...
        var landmark = util.isString(name)
            ...
            : name;
        if (landmark) {
            var _a = util.isNumber(options) ? { duration: options } : options, _b = _a.easing, easing = _b === void 0 ? 'linear' : _b, _c = _a.duration, duration_1 = _c === void 0 ? 100 : _c, _d = _a.easingFunction, easingFunction = _d === void 0 ? undefined : _d, _e = _a.onfinish, onfinish_1 = _e === void 0 ? undefined : _e, _f = _a.onframe, onframe_1 = _f === void 0 ? undefined : _f;
            var epsilon_1 = 0.01;
